...
flowchart TD
  ...
  pkg_web_search_local --> pkg_invariants
  pkg_web_search_local --> pkg_web
...
| [`web-search-local`](../packages/web/web-search-local) | `web` | [`invariants`](../packages/runtime-diagnostics/invariants), [`web`](../packages/web/web) |
